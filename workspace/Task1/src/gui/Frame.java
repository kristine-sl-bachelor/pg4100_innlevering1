...
import actions.FileMenuOptions;

/**
 * 
 * The JFrame that contains the paint window and the buttons.
 * 
...
public class Frame extends JFrame implements ActionListener, MouseListener,
	...
	public void windowClosing(WindowEvent e) {
		...
		if (paintWindow.coloredShapes.isEmpty())
			System.exit(0);
		else if (paintWindow.needsSaving) {
			int option = JOptionPane.showConfirmDialog(this,
					"Changes has been made.\nDo you want to save?");
			if (option == JOptionPane.YES_OPTION) {
				FileMenuOptions.save(this, paintWindow.saveFile,
						paintWindow.coloredShapes);
				System.exit(0);
